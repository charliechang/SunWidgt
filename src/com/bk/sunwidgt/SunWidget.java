...
public class SunWidget extends AppWidgetProvider {
    ...
    public void onUpdate(Context context,AppWidgetManager appWidgetManager, int[] appWidgetIds) {
        ...
        updateViews.setTextViewText(com.bk.sunwidgt.R.id.rise,  fmt.format(answer.sunrise )  + " " + (int) answer.sunrise_azel);
        updateViews.setTextViewText(com.bk.sunwidgt.R.id.set,  fmt.format(answer.sunset ) + " " + (int) answer.sunset_azel);
