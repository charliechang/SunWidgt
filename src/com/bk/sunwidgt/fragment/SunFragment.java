...
public class SunFragment extends Fragment{
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        final CalendarView calendarView = (CalendarView) view.findViewById(com.bk.sunwidgt.R.id.calendar);
        ...
        ((Button) view.findViewById(com.bk.sunwidgt.R.id.next_month)).setOnClickListener(new View.OnClickListener() {
        ...
        ((Button) view.findViewById(com.bk.sunwidgt.R.id.prev_month)).setOnClickListener(new View.OnClickListener() {
    ...
    private void setWeektable() {
        ...
        final CalendarView calendarView = (CalendarView) getView().findViewById(com.bk.sunwidgt.R.id.calendar);
    ...
    private void setTableRow(Calendar cal,double lat,double lng,int weekid,Calendar selectedDay) {
        ...
        final TableRow moonriseRow = (TableRow) getView().findViewById(com.bk.sunwidgt.R.id.moonrise);
